...
plt.title('1-bit重建'), plt.axis('off')

plt.show()
# print("1-bit-psnr:", psnr(img, bgr_re))
# print("1-bit-ssim:", ssim(img, bgr_re))
psnr1 = psnr(img, bgr_re)
ssim1 = ssim(img, bgr_re)
file = open("psnr and ssim1.txt", "w")
file.write("1-bit-psnr:"+str(psnr1)+"\n")
file.write("1-bit-ssim:"+str(ssim1)+"\n")