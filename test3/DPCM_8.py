...
plt.title('8-bit重建'), plt.axis('off')

plt.show()

# print("8-bitpsnr:", psnr(img, bgr_re))
# print("8-bitssim:", ssim(img, bgr_re))
psnr1 = psnr(img, bgr_re)
ssim1 = ssim(img, bgr_re)
file = open("psnr and ssim8.txt", "w")
file.write("8-bit-psnr:"+str(psnr1)+"\n")
file.write("8-bit-ssim:"+str(ssim1)+"\n")
file.close()
